...
**Backend** PHP (Laravel · Yii2) · Node.js (NestJS · Express) · Python (FastAPI · Django) · Go
**Frontend** React · Vue · Angular · TypeScript · Tailwind
**DevOps** Docker · Kubernetes · Terraform · Ansible · GitHub Actions · Nginx
**Cloud** AWS · Google Cloud · Cloudflare
**Data** PostgreSQL · MySQL · MongoDB · Redis · RabbitMQ
...
[![](profile-summary-card-output/github/1-repos-per-language.svg)](profile-summary-card-output/github/1-repos-per-language.svg) [![](profile-summary-card-output/github/3-stats.svg)](profile-summary-card-output/github/3-stats.svg)
